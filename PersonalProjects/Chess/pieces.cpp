...
public:
    ...
    void findPossibleMoves()
    {
        ...
        //find possible moves for pawn except en passant TBD
            if(this->moved==false){
                if(this->colour==true){
                    if(!board->isSquareOccupied(this->getPositionX(),this->getPositionY()+1)){
                        this->possibleMoves.push_back({this->getPositionX(),this->getPositionY()+1});
                        if(!board->isSquareOccupied(this->getPositionX(),this->getPositionY()+2)){
                            this->possibleMoves.push_back({this->getPositionX(),this->getPositionY()+2});
                        }
                    }
                    if(!board->isSquareOccupied(this->getPositionX()+1,this->getPositionY()+1)){
